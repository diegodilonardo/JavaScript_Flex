// Funcion que limpia los textos en el DOM de las cuotas 
...
// Funcion que limpia todos los elementos del DOM para una nueva operación
...
//Defino arrays de tarjetas con sus coeficientes de tarjetas de credito)
...
//Funciones de calculo para valores de importes, cuotas e intereses
...
//Funcion que guarda los calculos en un objeto
...
const valormonto = document.getElementById("montoacalcular")
    btncalcular.addEventListener("click", ()=>{
        ...
        Swal.fire({
            title: "Calculo de Monto, Cuotas, Intereses",
...
btnguardar.addEventListener("click", ()=>{
    Swal.fire({
        title: "Guardar información de Cálculos",
        showDenyButton: true,
        ...
        denyButtonText: `No Guardar`
         ...
         if (result.isConfirmed) {
            Swal.fire("Se guardaron los datos correctamente!", "", "Realizado");
            ...
            Swal.fire("No se registró la información", "", "información");
            
        }
    }
);

//Boton limpiar datos de DOM
